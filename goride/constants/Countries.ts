...
export const countries: Country[] = [
  ...
  { name: "Congo (Congo-Brazzaville)", flag: "🇨🇬", code: "CG", dialCode: "+242" },
  { name: "Congo (Democratic Republic of the)", flag: "🇨🇩", code: "CD", dialCode: "+243" },
  ...
  { name: "Myanmar (Burma)", flag: "🇲🇲", code: "MM", dialCode: "+95" },
  ...
  { name: "Palestine State", flag: "🇵🇸", code: "PS", dialCode: "+970" },
